<h1>
	Editar <?php echo $form->value('Localidad.nombre'); ?>
</h1>
...
<div class="bloque">
	...
	<p>
		Manten presionado el bot&oacute;n del rat&oacute;n sobre el marcador de la localidad en el mapa para modificar su ubicaci&oacute;n geogr&aacute;fica, o ingresa la latitud y la longitud de la localidad en siguientes campos
	</p>
	<?php
...
<div class="bloque">
	<div id="editarlocalidad" class="canvasmapa ancho100" style="height: 344px"></div>
</div>
