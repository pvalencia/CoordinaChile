...
function alternate(table) {
	...
	for (var i = 0; i < tableBodies.length; i++) {
		...
		for (var j = 0; j < tableRows.length; j++) {
			...
			if ( (j % 2) == 0  ) {
				if ( !(tableRows[j].className.indexOf('fila2') == -1) ) {
					tableRows[j].className = tableRows[j].className.replace('fila2', 'fila1');
				} else {
					if ( tableRows[j].className.indexOf('fila1') == -1 ) {
						tableRows[j].className += " fila1";
					}
				}
			} else {
				if ( !(tableRows[j].className.indexOf('fila1') == -1) ) {
					tableRows[j].className = tableRows[j].className.replace('fila1', 'fila2');
				} else {
					if ( tableRows[j].className.indexOf('fila2') == -1 ) {
						tableRows[j].className += " fila2";
					}
				}
			} 
		}
